...
h1, p {
	...
	var person = new Object();   // Create the object
    person.logged_in_user = "Faculty_User";     // Assign properties to the object
    person.location  = "Faculty";
	...
	<%-- <% window.localStorage.setItem("Admin_User", JSON.stringify(person)); %> --%>

	 
	<%-- <% request.setAttribute("admin", "adminpage"); %> --%>
	
<body>

<div style="padding-left:16px; text-align:center; background-color:LightGray">
  <h1>STUDENT MANAGEMENT SYSTEM - ADMIN'S LOGIN</h1>
</div>
...
//Created for back button based on user logged in:
/* var person = new Object();   // Create the object
person.logged_in_user = "Faculty_User";     // Assign properties to the object
person.location  = "Faculty";
